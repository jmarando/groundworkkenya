  ...
  head: () => ({
    meta: [
      { title: "Briefing · Groundwork" },
      {
        name: "description",
        content:
          "The whole campaign in one read: constituencies, wards, issues and who is on the list.",
      },
      ...
      <div className="g5 fx2">
        ...
        <div className="card kpi">
          ...
          <span className="kpi-sub">
            {pct(t?.supporters ?? 0, t?.target ?? 0)} of it confirmed
          </span>
        </div>
        <div className="card kpi">
        ...
        <div className="card kpi">
          ...
          <span className="kpi-sub">
            {nf.format(t?.contactedWeek ?? 0)} contacted this week
          </span>
        </div>
        <div className="card kpi">
