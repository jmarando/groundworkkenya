...
export const Route = createFileRoute("/_authenticated/warroom")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Parallel tally, station coverage and incidents as election night runs.",
      },
    ...
    <section className="view w active" data-surface="warroom" aria-label="War room">
      ...
      <div className="w-grid">
        <div className="card w-span7 fx2">
          ...
          <p className="method">
            Parallel tally of photographed, signed Form 34A results as observed by our agents.
            Coverage is stated on every figure. This system reports; it does not declare results.
          </p>
        </div>
        ...
        <div className="w-rail fx5">
          <div className="card">
            <div className="card-head">
              <h2>Incidents</h2>
              <span className="mono">
                {data.incidents.length} logged · chain of custody kept
              </span>
            </div>
